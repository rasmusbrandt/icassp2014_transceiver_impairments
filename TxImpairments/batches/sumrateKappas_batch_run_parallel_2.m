...
sim_params.run_tdma    = false;
sim_params.run_maxrate = true;
sim_params.run_maxsinr = true;


% Scenario parameters
Nnetworks = 50;    % number of user drops to simulate
...
fixed_kappa = 10/100;
loop_kappas = (1/100)*(1:15);
third_order_bs_kappas = 10.^([18.2 15.2]/20);		% script only support two parameters so far...
...
% Run simulation
sumrateKappas_batch_perform;


% Save results
if(save_results)
  save('sumrateKappas_run2');
end