...
sumrateKappas_tdma_compensate           = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_tdma_ignore               = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_tdma_noimp                = zeros(Kr,Nsim,Nnetworks);

sumrateKappas_maxrate_compensate        = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_maxrate_ignore_smart      = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_maxrate_ignore_oblivious  = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_maxrate_noimp             = zeros(Kr,Nsim,Nnetworks);

sumrateKappas_maxsinr_compensate        = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_maxsinr_ignore_smart      = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_maxsinr_ignore_oblivious  = zeros(Kr,length(linear_bs_kappas),length(linear_ms_kappas),Nsim,Nnetworks);
sumrateKappas_maxsinr_noimp             = zeros(Kr,Nsim,Nnetworks);
